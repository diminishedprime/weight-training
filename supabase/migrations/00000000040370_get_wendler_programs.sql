DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'wendler_block_row') THEN
    CREATE TYPE public.wendler_block_row AS (
      id uuid,
    ...
    CREATE TYPE public.wendler_movement_row AS (
      ...
      blocks public.wendler_block_row[]
    );

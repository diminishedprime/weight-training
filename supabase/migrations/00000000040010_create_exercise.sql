...
-- is completed, then it needs a performed_at timestamp.
    INSERT INTO public.exercises (
        user_id, exercise_type, equipment_type, performed_at, target_weight_value, actual_weight_value, weight_unit, reps, is_warmup, is_amrap, completion_status, notes, perceived_effort
    ) VALUES (
        p_user_id, p_exercise_type, p_equipment_type, p_performed_at, p_target_weight_value, p_actual_weight_value, p_weight_unit, p_reps, p_is_warmup, p_is_amrap, p_completion_status, p_notes, p_perceived_effort
    )
